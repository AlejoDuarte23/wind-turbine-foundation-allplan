...
class Parametrization(vkt.Parametrization):
    ...
    geometry.foundation_edge_thickness = vkt.NumberField("Foundation edge thickness", default=1000.0, min=300.0, suffix="mm", flex=50)
    geometry.foundation_center_thickness = vkt.NumberField("Foundation center thickness", default=1900.0, min=500.0, suffix="mm", flex=50)
    geometry.pedestal_diameter = vkt.NumberField("Pedestal diameter", default=5000.0, min=1000.0, suffix="mm", flex=50)
